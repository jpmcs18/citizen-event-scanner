...
export function toDateDisplay3(date?: Date | null): string {
  if (date === undefined || date === null) return '';
  const months = [
    'Jan',
    'Feb',
...
export function toDateDisplay2(date?: Date | null): string {
  if (date === undefined || date === null) return '';
  const d = new Date(date);
  return (
    (d.getMonth() + 1).toString().padStart(2, '0') +
...
export function toDateDisplay4(date?: Date | null): string {
  if (date === undefined || date === null) return '';
  const d = new Date(date);
  return (
    (d.getMonth() + 1).toString().padStart(2, '0') +
